...
- **Tab state is stored in EditorPrefs.** If EditorPrefs are cleared (e.g. via *Edit › Clear All PlayerPrefs*), all tabs will be lost. This does not affect project assets.
